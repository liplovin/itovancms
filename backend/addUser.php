...
if ($method == "POST") {
    ...
    $isAdmin = isset($data['is_admin']) ? $data['is_admin'] : 0; // Check if is_admin is provided, default to 0 if not
    $sql = "INSERT INTO users (firstName, lastName, username, email, password, is_admin) VALUES (:firstName, :lastName, :username, :email, :password, :is_admin)";
